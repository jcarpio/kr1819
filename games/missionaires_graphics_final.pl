...
% [move(1,1,left),move(1,0,right),move(0,2,left),move(0,1,right),move(2,0,left),move(1,1,right),move(2,0,left),move(0,1,right),move(0,2,left),move(0,1,right),move(0,2,left)]
...
drawTextMov(Window, move(M,C,Side), Text):-
  format(atom(String), 'move(~d Mis, ~d Can, ~w)', [M, C, Side]),
  send(Window, display,
          new(Text, text(String)), point(125, 10)).		  
